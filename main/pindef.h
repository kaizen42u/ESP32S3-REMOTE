...
#define JOYSTICK_SHIELD_BUTTON_A (GPIO_NUM_18)
#define JOYSTICK_SHIELD_BUTTON_B (GPIO_NUM_17)
#define JOYSTICK_SHIELD_BUTTON_C (GPIO_NUM_19)
#define JOYSTICK_SHIELD_BUTTON_D (GPIO_NUM_20)
#define JOYSTICK_SHIELD_BUTTON_E (GPIO_NUM_3)
#define JOYSTICK_SHIELD_BUTTON_F (GPIO_NUM_14)
#define JOYSTICK_SHIELD_BUTTON_K (GPIO_NUM_21)
#define JOYSTICK_SHIELD_JOYSTICK_X (GPIO_NUM_2)
#define JOYSTICK_SHIELD_JOYSTICK_Y (GPIO_NUM_1)
